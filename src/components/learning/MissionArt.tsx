...
export function SkyScatterArt({ label }: MissionArtProps) {
  return (
    <svg viewBox="0 0 300 260" fill="none" role="img" aria-label={label}>
      ...
      <path d="M150 118 L128 92 M150 118 L178 96 M150 118 L186 126 M150 118 L160 150 M150 118 L118 132" stroke="#2F6FD6" strokeWidth="4" strokeLinecap="round" />
      <circle cx="150" cy="118" r="7" fill="#1C1B2E" />
      <circle cx="126" cy="88" r="4" fill="#2F6FD6" />
      <circle cx="182" cy="92" r="4" fill="#2F6FD6" />
      <circle cx="190" cy="127" r="4" fill="#2F6FD6" />
      <circle cx="114" cy="134" r="4" fill="#2F6FD6" />
    </svg>
  )
}
...
export function TransitArt({ label }: MissionArtProps) {
  return (
    <svg viewBox="0 0 300 260" fill="none" role="img" aria-label={label}>
      ...
      <circle cx="130" cy="96" r="13" fill="#1C1B2E" />
      ...
      <path d="M28 176 H112 Q124 176 128 200 H172 Q176 176 188 176 H272" stroke="#2F6FD6" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
