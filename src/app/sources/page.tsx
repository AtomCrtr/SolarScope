  ...
  return (
    <div className="container prose-page sources-page">
      ...
      <section className="card prose-card">
        ...
        <p>Les textes des leçons, des questions et des guides sont sous licence <a href="https://creativecommons.org/licenses/by/4.0/deed.fr" target="_blank" rel="noopener noreferrer">CC BY 4.0</a> : tu peux les reprendre en classe ou ailleurs en citant « SolarScope ». Le <a href="https://github.com/AtomCrtr/SolarScope" target="_blank" rel="noopener noreferrer">code source</a> est sous licence MIT. Les images des agences spatiales gardent leurs propres conditions.</p>
